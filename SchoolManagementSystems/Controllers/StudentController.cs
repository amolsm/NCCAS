...
namespace SchoolManagementSystems.Controllers
{
    ...
    public class StudentController : Controller
    {
        ...
        public ActionResult Admission_DML(Studentviewmodel svm, string action, HttpPostedFileBase files1, HttpPostedFileBase files2, HttpPostedFileBase filesh1, HttpPostedFileBase filesh2, HttpPostedFileBase filesh3, HttpPostedFileBase files3, HttpPostedFileBase filemotherpic, HttpPostedFileBase files5, HttpPostedFileBase files6, HttpPostedFileBase files7, HttpPostedFileBase files8, HttpPostedFileBase files9, int? id, HttpPostedFileBase FileUpload1, string group1)
        {
            ...
            try
            {
                svm.St_Status = Convert.ToInt32(group1);
            }
            catch { svm.St_Status = 0; }
            if (files1 != null)
            {
            ...
            if (action != "delete")
            {
                ...
                try
                {
                 ...
                 svm.FatherOccumationName, svm.FatherQualificationName, svm.GuardianOccpationName, svm.GuardianQualificationName, svm.MotherOccpationName, svm.MotherQualificationName, svm.StdRegMob, svm.StdRegNo, svm.emcontactrel, svm.St_Status,
        ...
        private void SendUserEmails(string Email)
        {
            ...
            string msg = "Dear Student/Parent," + "<br/><br/>";
            msg = msg + "Welcome to “<b>Nanjil Catholic College Of Arts & Science</b>”<br/><br/>";
            msg = msg + "This is with great pleasure we are introducing our College’s online software.This is an initiative towards improving communication between College, Students and parents and also towards automation of the College system.”</b><br/><br/>";
            msg = msg + "Your UserName : " + Email + ".<br/>";
            msg = msg + "Your Password : " + pass + ".<br/>";
            msg = msg + "For any issue related to login please send an email to 24HDS.team@gmail.com<br/><br/>Best Regards<br/>NACCAS Management & OIMS24hrsDesign Team.<br/><br/>";
            msg = msg + "***** Email confidentiality notice *****<br/>";
            msg = msg + "The information contained in this communication is confidential and may be legally privileged.It is intended solely for the use of the individual or entity to whom it is addressed and others authorized to receive it.If you are not the intended recipient you are hereby(a) notified that any disclosure, copying, distribution or taking any action with respect to the content of this information is strictly prohibited and may be unlawful, and(b) kindly requested to inform the sender immediately and destroy any copies.Nanjil Catholic College of Arts and Science, Kaliyakkavilai is neither liable for the proper and complete transmission of the information contained in this communication nor for any delay in its receipt.";
            message.Body = msg;
        ...
        private void SendEmails(string Email)
        {
            ...
            msg = msg + "Dear Student: " + db.tbl_student.Where(m => m.StudEmail== Email).Select(m => m.Studnm).FirstOrDefault() + " .<br/>";
        ...
        public JsonResult GetRegisterationNo(string acadmicyear, int deptid)
        {
            string acyear = acadmicyear.Substring(0, 4);
            var data = db.sp_GetStdCount(deptid, acadmicyear);
