    ...
    public class MastersController : Controller
    {
        ...
        public ActionResult DMLEmp(employeeviewmodel _bgv, string evt, int id, HttpPostedFileBase empfile, HttpPostedFileBase empfile1)
        {
            ...
            if (evt == "submit")
            {
                ...
                try
                {
                    db.sp_employee_DML(_bgv.Empid, _bgv.FirstName, _bgv.MiddleName, _bgv.LastName, _bgv.Cityid, _bgv.Stateid, _bgv.Zipcode, _bgv.Emailid, _bgv.PhoneNo, _bgv.MobileNo, _bgv.Address, Convert.ToString(_bgv.DOB), _bgv.Gender, _bgv.Quallification, Convert.ToString(_bgv.DateOfJoin), _bgv.Typeid, _bgv.Code, _bgv.OQualification, "NA", _bgv.edepartment, _bgv.eblood, _bgv.equalification1, _bgv.euniversity1, _bgv.eprecentage1, _bgv.eYearofpassing1, _bgv.equalification2, _bgv.euniversity2, _bgv.eprecentage2, _bgv.eYearofpassing2, _bgv.equalification3, _bgv.euniversity3, _bgv.eprecentage3, _bgv.eYearofpassing3, _bgv.equalification4, _bgv.euniversity4, _bgv.eprecentage4, _bgv.eYearofpassing4, _bgv.eweight, _bgv.eheight, _bgv.emppic, _bgv.eidtype, _bgv.dname, _bgv.DCode, _bgv.dcontact, _bgv.daddress, _bgv.relationship, _bgv.pname, _bgv.poccupation, _bgv.pqualification, _bgv.pemail, _bgv.pofficeaddress, _bgv.PCODE, _bgv.pcontact, _bgv.ppic, _bgv.pastreet, _bgv.pacity, _bgv.pastate, _bgv.pacountry, _bgv.papin, _bgv.cstreet, _bgv.ccity, _bgv.cstate, _bgv.ccountry, _bgv.cpin, _bgv.PHCODE, _bgv.phome, _bgv.MCODE, _bgv.hmobile, _bgv.bankname, _bgv.branch, _bgv.ifsccode, _bgv.accountno, _bgv.acname, _bgv.collagename, _bgv.university, Convert.ToString(_bgv.joiningdate), Convert.ToString(_bgv.lastdate), _bgv.total, _bgv.ldesignation, _bgv.companyname, _bgv.clastdesignation, Convert.ToString(_bgv.cjoiningdate), Convert.ToString(_bgv.clastdate), _bgv.ctotal, _bgv.employeeemail, _bgv.empreligion, _bgv.empcategory, _bgv.empcast, _bgv.mtongue, _bgv.collagename1, _bgv.university1, Convert.ToString(_bgv.joiningdate1), Convert.ToString(_bgv.lastdate1),
                       _bgv.total1, _bgv.ldesignation1, _bgv.companyname1, _bgv.clastdesignation1,Convert.ToString(_bgv.cjoiningdate1),Convert.ToString(_bgv.clastdate1), _bgv.ctotal1, _bgv.Documenttypename, _bgv.DocumentIDNo, _bgv.conttactrelation, _bgv.ParishName, _bgv.DioceseName, _bgv.collagename2, _bgv.university2, Convert.ToString(_bgv.joiningdate2), Convert.ToString(_bgv.lastdate2),
                       _bgv.total2, _bgv.ldesignation2, _bgv.companyname2, _bgv.clastdesignation2,Convert.ToString(_bgv.cjoiningdate2),Convert.ToString(_bgv.clastdate2), _bgv.ctotal2, _bgv.collagename3, _bgv.university3,Convert.ToString(_bgv.joiningdate3),Convert.ToString(_bgv.lastdate3),
                       _bgv.total3, _bgv.ldesignation3, _bgv.companyname3, _bgv.clastdesignation3,Convert.ToString(_bgv.cjoiningdate3),Convert.ToString(_bgv.clastdate3), _bgv.ctotal3, _bgv.collagename4, _bgv.university4,Convert.ToString(_bgv.joiningdate4),Convert.ToString(_bgv.lastdate4),
                       _bgv.total4, _bgv.ldesignation4, _bgv.companyname4, _bgv.clastdesignation4,Convert.ToString(_bgv.cjoiningdate4),Convert.ToString(_bgv.clastdate4), _bgv.ctotal4, _bgv.collagename5, _bgv.university5,Convert.ToString(_bgv.joiningdate5),Convert.ToString(_bgv.lastdate5),
                       _bgv.total5, _bgv.ldesignation5, _bgv.companyname5, _bgv.clastdesignation5,Convert.ToString(_bgv.cjoiningdate5),Convert.ToString(_bgv.clastdate5), _bgv.ctotal5, _bgv.collagename6, _bgv.university6,Convert.ToString(_bgv.joiningdate6),Convert.ToString(_bgv.lastdate6),
                       _bgv.total6, _bgv.ldesignation6, _bgv.companyname6, _bgv.clastdesignation6,Convert.ToString(_bgv.cjoiningdate6),Convert.ToString(_bgv.clastdate6), _bgv.ctotal6, _bgv.collagename7, _bgv.university7,Convert.ToString(_bgv.joiningdate7),Convert.ToString(_bgv.lastdate7),
                       _bgv.total7, _bgv.ldesignation7, _bgv.companyname7, _bgv.clastdesignation7,Convert.ToString(_bgv.cjoiningdate7),Convert.ToString(_bgv.clastdate7), _bgv.ctotal7, _bgv.collagename8, _bgv.university8,Convert.ToString(_bgv.joiningdate8), Convert.ToString(_bgv.lastdate8),
                       _bgv.total8, _bgv.ldesignation8, _bgv.companyname8, _bgv.clastdesignation8,Convert.ToString(_bgv.cjoiningdate8), Convert.ToString(_bgv.clastdate8), _bgv.ctotal8, _bgv.collagename9, _bgv.university9,Convert.ToString(_bgv.joiningdate9), Convert.ToString(_bgv.lastdate9),
                       _bgv.total9, _bgv.ldesignation9, _bgv.companyname9, _bgv.clastdesignation9, Convert.ToString(_bgv.cjoiningdate9), Convert.ToString(_bgv.clastdate9), _bgv.ctotal9, _bgv.q_department1, _bgv.q_department2, _bgv.q_department3, _bgv.q_department4, _bgv.q_Set, _bgv.q_Net, _bgv.q_SetPassingYear, _bgv.q_NetPassingYear
                       ).ToString();
                }
                catch (Exception ex)
                {
        ...
        #region Lecture Time SetUp master
        public ActionResult LectureSetUp(string Search_Data)
        {
            ...
            if (String.IsNullOrEmpty(Search_Data))
                ...
                _ltsvm._LecttimeSetupList = db.sp_GetLectTimeSetUp().Where(x => x.LecTime.ToUpper().Contains(Search_Data.ToUpper())
                                                        || x.status.ToUpper().Contains(Search_Data.ToUpper())).ToList();
            return View(_ltsvm);
        }
        public JsonResult FillLectureSetUp(int LecTimeid)
        {
        ...
        {
            if (_ltsvm.LecTimeId.ToString() != null && _ltsvm.LecTimeId != 0)
            {
                tbl_LectTimeSetUp tbl = db.tbl_LectTimeSetUp.Where(x => x.LecTimeid == _ltsvm.LecTimeId).FirstOrDefault();
                db.ObjectStateManager.ChangeObjectState(tbl, System.Data.EntityState.Modified);
                tbl.LecNo = _ltsvm.LecNo;
            ...
            {
                tbl_LectTimeSetUp tbl = new tbl_LectTimeSetUp();
                tbl.LecNo = _ltsvm.LecNo;
                tbl.LecTime = _ltsvm.LecTime;
                tbl.LectETime = _ltsvm.LecETime;
                tbl.Status = _ltsvm.status;
                ...
                _ltsvm._LecttimeSetupList = db.sp_GetLectTimeSetUp().ToList();
            return PartialView("_LectureSetUplist", _ltsvm);
        }
        #endregion
    }
}
