...
namespace Entity
{
    public class employeeviewmodel
    {
        ...
        public string eheight { get; set; }

        [DisplayName("Employee's Pic ")]
        public byte[] emppic { get; set; }

        [DisplayName("ID Type: ")]
        public int eidtype { get; set; }
        ...
        public string eprecentage1 { get; set; }
        ...
        [DisplayName("Precentage ")]
        public string eprecentage2 { get; set; }
        ...
        [DisplayName("Precentage ")]
        public string eprecentage3 { get; set; }
        ...
        [DisplayName("Precentage ")]
        public string eprecentage4 { get; set; }
        ...
        [DisplayName("Precentage ")]
        public string eprecentage5 { get; set; }
